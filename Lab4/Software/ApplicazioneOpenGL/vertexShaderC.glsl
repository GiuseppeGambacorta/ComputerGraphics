...
// variabili che rimangono costanti per ogni primitiva
uniform mat4 Model;			//matrice di modellazione da applicare ai vertici: composizione di trasformazioni elementari
uniform mat4 Projection;	//la matrice di Proiezione, che dalle coordinate e del mondo alle coordinate NDC (-1,1)
...
void main(){	
	gl_Position = Projection*Model*vec4(aPos.x,aPos.y,aPos.z,1.0);  //Assegna alla variabile predefinita gl_Position  la posizione del vertice in coordinate omogenee(x, y, z, w)
	colore_frag= Color;
}
